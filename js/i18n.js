const i18n = {
  ...
  ko: {
    ...
    tsu_sheet1_desc: '여름에는 당연히 세라복이지! 하지만 분명 더울텐데 장갑을 벗지않는다.',
    tsu_sheet2_desc: '순한 외모 덕분에 격투기와는 전혀 상관없어보이지만, 우연한 계기로 도전하게 되었다!<br>매번 상처투성이가 되어오지만 그 싸움 속에서 매번 어떤 재미를 찾아오는건지 도저히 끊지를 않는다.',
